...
*/
const XPTN = 'LBOT'; // Nama Bot Whatsapp
const instagram = 'https://instagram.com/LKY_DESIGN'; // Nama Instagramlu cok
const nomer = 'https://Wa.me/+6285235664215'; // Nomor whatsapplu cok
const aktif = 'Manot Dalange'; // Kapan bot lu aktif
const groupwa = 'https://chat.whatsapp.com/IKmRs4a36fIAyn7X16jpwL'; // OFFICIAL GRUP LU 1
const youtube = 'https://youtube.com/channel/UCSIoC18pm8G-11K0RBoQf2Q'; // OFFICIAL GRUP LU 2
//
...
conn.sendMessage(id, '3aalaikumsalam, Ketik +list/+info/+donasi Contoh +list' ,MessageType.text);
}
else if (text == 'salam'){
conn.sendMessage(id, 'Waalaikumsalam, Ketik +list/+info/+donasi Contoh +list' ,MessageType.text);
}
...
conn.sendMessage(id, 'Ya?, Ketik +list/+info/+donasi Contoh +list' ,MessageType.text);
}
else if (text == 'P'){
conn.sendMessage(id, 'Ya?, Ketik +list/+info/+donasi Contoh +list' ,MessageType.text);
}
...
conn.sendMessage(id, 'Owner BANGLENT wa.me/+6285235664215' ,MessageType.text);
}
...
conn.sendMessage(id, 'Test 1,2,3 ketik +list' ,MessageType.text);
}
else if (text == 'Hai'){
conn.sendMessage(id, 'Ya?, Ketik +list/+info/+donasi Contoh +list' ,MessageType.text);
}
else if (text == '+ttp'){
conn.sendMessage(id, ' *COMMAND PREMIUM CHAT WA https://wa.me/6285235664215* ' ,MessageType.text);
}
else if (text == 'Woi'){
conn.sendMessage(id, 'Ya?, Ketik +list/+info/+donasi Contoh +list' ,MessageType.text);
}
...
conn.sendMessage(id, 'SUM Add Sum asik dia wa.me/+628557' ,MessageType.text);
}
else if (text == '.coowner'){
conn.sendMessage(id, 'L add L wa.me/+6285235664215' ,MessageType.text);
}
...
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan *LBOT*, Follow Instagram Mimin Yah😻 : https://instagram.com/naslent11' ,MessageType.text);
}
else if (text == '.tool2'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan *LBOT* , Follow Instagram Mimin Yah😻 : https://instagram.com/maslent11' ,MessageType.text);
}
else if (text == '.tools3'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan *LBOT* , Follow Instagram Mimin Yah😻 : https://instagram.com/maslent11' ,MessageType.text);
}
...
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan *LBOT* , Follow Instagram Mimin Yah😻 : https://www.youtube.com/channel/UCAn_1yox-jIUFhUVYTxI_JA' ,MessageType.text);
}
...
if (text.includes("+meme"))
   {
    var items = ["funny meme", "meme", "meme 2020", "meme Indonesia"];
    var cewe = items[Math.floor(Math.random() * items.length)];
    var url = "https://api.fdci.se/rep.php?gambar=" + cewe;
  ...
  var teks = text.replace(/.ssweb /, '')
    ...
    .then((res) => {
      imageToBase64(res.data.result)
        .then(
          (ress) => {
            conn.sendMessage(id, '[❗] BENTAR', MessageType.text)
            var buf = Buffer.from(ress, 'base64')
            conn.sendMessage(id, buf, MessageType.image)
        })
    })
